...
namespace BuildConfigurator.Tests.v2.PartRequiresPart
{
    ...
    {
        [Test, Category(TestCategories.IND), Category(TestCategories.PART_REQUIRES_PART), CustomRetry(3)]
        public void VerifyPartRequiresPartTriggeredGen()
        {
            ...
            Assert.IsTrue(BuildConfigurePage.VerifyAccesoriesOnBuildSummary(new string[] { "2879674-266", "2879667-05" }));
